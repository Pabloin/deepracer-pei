...
amiId=$( aws ec2 describe-images --owners 730335328884 --filters "Name=state,Values=available"                              --query 'sort_by(Images, &CreationDate)[-1].ImageId' | tr -d '"')

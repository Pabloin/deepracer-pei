...
class LunaCar:
    ...
    def reko_fun(self, params):
        ...
        if pp1 in range(100, 115+1) and speed >= 3.2:
            recompensa *= 1.2

        if pp1 in range(215, 223+1) and speed >= 3.2:
            recompensa *= 1.2

        if pp1 in range( 25, 40+1)  and speed >= 3.2:
            recompensa *= 1.2

        if pp1 in range( 55, 70+1)  and speed >= 3.0:
            recompensa *= 1.2
        ...
        if pp1 in range( 10, 20+1)  and speed >= 1.8:
            recompensa *= 1.2

        if pp1 in range( 80, 90+1)  and speed >= 1.8:
            recompensa *= 1.2

        if pp1 in range(190, 205+1)  and speed >= 1.8:
            recompensa *= 1.2

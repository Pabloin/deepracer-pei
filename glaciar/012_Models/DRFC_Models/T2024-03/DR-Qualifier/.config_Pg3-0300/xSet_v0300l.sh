...
cp   ./custom_files/hyperparameters_v0300l.json  ${MY_HOME_DRFC}/custom_files/hyperparameters.json

cp   ./run_v0300l.env       ${MY_HOME_DRFC}/run.env
cp   ./system_v0300l.env    ${MY_HOME_DRFC}/system.env
...
ee3 system.env DR_SAGEMAKER_IMAGE=
ee3 system.env DR_ROBOMAKER_IMAGE=

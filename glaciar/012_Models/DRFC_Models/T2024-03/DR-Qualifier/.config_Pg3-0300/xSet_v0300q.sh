...
cp   ./custom_files/hyperparameters_v0300q.json  ${MY_HOME_DRFC}/custom_files/hyperparameters.json

cp   ./run_v0300q.env       ${MY_HOME_DRFC}/run.env
cp   ./system_v0300q.env    ${MY_HOME_DRFC}/system.env

...
## De esta config
cp   ./custom_files/reward_function_v0100w.py     ${MY_HOME_DRFC}/custom_files/reward_function.py
cp   ./custom_files/model_metadata.json           ${MY_HOME_DRFC}/custom_files/model_metadata.json
cp   ./custom_files/hyperparameters_v0100y.json   ${MY_HOME_DRFC}/custom_files/hyperparameters.json


cp   ./run_v0100w.env       ${MY_HOME_DRFC}/run.env
